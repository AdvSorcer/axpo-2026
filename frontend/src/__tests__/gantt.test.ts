...
describe("Frontend Gantt & Timeline Utility Unit Tests", () => {
  ...
  it("getLocalDateString correctly returns local timezone YYYY-MM-DD instead of UTC offset date", () => {
    ...
    const testDate = new Date(2026, 7, 4, 1, 38) // Aug 4, 2026 01:38 Local Time
    expect(getLocalDateString(testDate)).toBe("2026-08-04")
  })
})
